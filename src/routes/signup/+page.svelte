<script lang="ts">
    ...
    async function sendVerificationEmail(): Promise<void> {
        ...
        // api call here
        alert('Follow the link included in the confirmation email to continue with the complete-signup process')
    }

</script>
<div class="flex items-center justify-center h-screen bg-[url('/images/login-bg.png')] bg-cover">
    <div class="flex flex-col items-center text-primary justify-center h-[72%] w-full max-w-[375px] max-h-[612px] bg-white drop-shadow-lg">
        <div class="font-khula pb-6 text-center">
            ...
            <h2 class="text-center text-base opacity-50 -mt-[.5rem]">START SIGNUP PROCESS</h2>
        </div>
        <div class="w-full px-[2rem] pb-3">
            <div class="font-khula pb-3 flex flex-col justify-between">
                <label for="email" class="text-md pl-2">
                    Email
                </label>
                <input type="email"
                       id="email"
        ...
        <div class="flex items-center flex-col">
            <button class="w-[10rem] h-[2.2rem] uppercase font-bold bg-primary rounded-lg text-white mb-5"
